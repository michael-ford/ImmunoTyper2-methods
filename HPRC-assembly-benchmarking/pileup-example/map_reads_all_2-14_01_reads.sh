...
# Hard-coded paths
REFERENCE_FASTA="concatenated-all.fasta"
READS_PATH="HG00438_assigned_reads_IGLV2-14_01.fa"

# Define output filenames
OUTPUT_PREFIX="HG00438_assigned_reads_IGLV2-14-all-01_reads_comparison_bowtie2"
